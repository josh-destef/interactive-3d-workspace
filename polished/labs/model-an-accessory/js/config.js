...
export const COPY = {
  0: { step: '', title: 'Four shapes. One Back Unit.', body: 'A Back Unit is a custom back module for Gizmobot. Watch its four pieces separate: two cubes, a cylinder and a sphere. Simple shapes can become something new!', panel: '<b>Watch the four pieces pull apart, then come together.</b> Two cubes, a cylinder and a sphere make this Back Unit. Yours could be a scanner, a power unit or something nobody has invented yet.', cta: 'See the four pieces' },
