const QUESTIONS = [
    {
        q: 'The arm root rotates. Why does the wrist move even though its local position stays the same?',
        options: [
            ...
            { text: 'The wrist copies the arm root angle into its own value', why: 'Its own local value does not change. The parent transforms are applied on top when the world transform is calculated.' },
            { text: 'Every object in the scene always follows the arm root', why: 'Only descendants of the arm root follow it. Unrelated root objects do not.' },
        ],
    },
    {
        ...
        options: [
            ...
            { text: 'The hand', why: 'The hand is a descendant of the elbow, so it travels with it.' },
        ],
    },
    {
        q: 'What changed when the hand picked up the block?',
        options: [
