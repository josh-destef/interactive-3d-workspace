...
export function buildMouseDiagram(type) {
    const defs = {
        orbit:    { left: true,  right: false, scroll: false, color: '#1a1a2e', motion: 'arc',   label: 'Click + drag' },
        zoom:     { left: false, right: false, scroll: true,  color: '#1a1a2e', motion: 'updown', label: 'Scroll' },
        pan:      { left: false, right: true,  scroll: false, color: '#1a1a2e', motion: 'lr',    label: 'Right-click + drag' },
        'move-x': { left: true,  right: false, scroll: false, color: '#c0453a', motion: 'lr',    label: 'Click + drag' },
